...
function buildPortCrackerObject(ns, crackName) {
  var crack = {
    ...
    name: crackName,
    exists: function() {
      return this.instance.fileExists(crackName, 'home');
    },
...
function buildServerObject(ns, node) {
  var server = {
    ...
    canCrack: function() {
      return getPortCrackers(this.instance) >= this.portsRequired;
    },
    canHack: function() {
      return this.hackingRequired <= this.instance.getHackingLevel();
    },
    shouldHack: function() {
      return (
        this.maxMoney > 0 &&
        this.name !== 'home' &&
        !this.instance.getPurchasedServers().includes(this.name)
      );
    },
    money: function() {
      return this.instance.getServerMoneyAvailable(this.name);
    },
    security: function() {
      return this.instance.getServerSecurityLevel(this.name);
    },
    isPrepping: function() {
    ...
    serverGrowthPercentage: function() {
      return (
        (this.instance.getServerGrowth(this.name) *
          bitnodeGrowMult *
    ...
    adjustedGrowthRate: function() {
      return Math.min(
        maxGrowthRate,
        1 + (unadjustedGrowthRate - 1) / this.minSecurity
      );
    },
    ...
    targetGrowthCoefficientAfterTheft: function() {
      return (
        1 /
        (1 - this.hackThreadsNeeded() * this.percentageStolenPerHackThread())
      );
    },
    ...
    hackingSkillCoefficient: function() {
      return (
        (this.instance.getHackingLevel() - (this.hackingRequired - 1)) /
        this.instance.getHackingLevel()
      );
    },
    ...
    weakenThreadsNeededAfterTheft: function() {
      return Math.ceil(
        (this.hackThreadsNeeded() * hackThreadHardening) / actualWeakenPotency()
      );
    },
    weakenThreadsNeededAfterGrowth: function() {
      return Math.ceil(
        (this.growThreadsNeededAfterTheft() * growthThreadHardening) /
          actualWeakenPotency()
      );
    },
    ...
    hasRoot: function() {
      return this.instance.hasRootAccess(this.name);
    },
    isHost: function() {
      return this.name == daemonHost;
    },
    getRam: function() {
      return this.instance.getServerRam(this.name);
    },
    ...
    growDelay: function() {
      return this.timeToWeaken() - this.timeToGrow() + arbitraryExecutionDelay;
    },
    hackDelay: function() {
      return this.timeToWeaken() - this.timeToHack();
    },
    timeToWeaken: function() {
      return this.instance.getWeakenTime(this.name);
    },
    timeToGrow: function() {
      return this.instance.getGrowTime(this.name);
    },
    timeToHack: function() {
      return this.instance.getHackTime(this.name);
    },
    weakenThreadsNeeded: function() {
      return Math.ceil(
        (this.security() - this.minSecurity) / actualWeakenPotency()
      );
    },
  };
  return server;
